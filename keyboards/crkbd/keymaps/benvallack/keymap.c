...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
      KC_NO, KC_Y,   KC_C,     KC_L,     KC_M,    KC_K,    						                KC_Z,   KC_F,   KC_U,   TD(DANCE_2),  KC_BSPC, KC_NO
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
      KC_NO, KC_I,    KC_S,    MT(MOD_LALT,KC_R),    MT(MOD_LGUI,KC_T),    KC_G,  	            KC_P,   MT(MOD_RGUI,KC_N),   MT(MOD_RALT,KC_E),  KC_A,  KC_O, KC_NO
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
      KC_NO, KC_Q,   KC_V,  KC_W,   KC_D,  KC_J,     							                KC_B,   KC_H,   TD(DANCE_3),   TD(DANCE_1),   KC_X, KC_NO
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  ...
  [1] = LAYOUT(
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_NO, KC_ESCAPE,KC_AT    ,LSFT(KC_3)     ,TD(DANCE_31)     ,KC_PERC    ,KC_CIRC    ,KC_AMPR   ,KC_ASTR   ,KC_SCOLON   ,KC_BSPC , KC_NO
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_NO, KC_TAB,KC_EQL    ,LALT(KC_RBRACKET)    ,LALT(LSFT(KC_RBRACKET))    ,TD(DANCE_32)    ,TD(BKSL_HME),LSFT(KC_LBRC),LSFT(KC_RBRC),TD(PIPE_END),KC_ENTER   , KC_NO
  //----------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_NO, KC_TILD, TD(DANCE_33)   ,LALT(KC_LBRACKET)   ,LALT(LSFT(KC_LBRACKET))   ,KC_DQUO   ,KC_LBRC     ,KC_LPRN   ,KC_RPRN   ,KC_RBRC   ,TO(3)   , KC_NO
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
    KC_NO, RESET,   KC_KP_ASTERISK, KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,KC_KP_DOT,   KC_0,   KC_1, KC_2, KC_3,   KC_TRANSPARENT, KC_NO
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
	  KC_NO, TO(0), KC_LGUI,KC_RALT ,TO(2), KC_NO
  ),

  [3] = LAYOUT(
      KC_NO, TD(DANCE_54),   KC_MS_WH_LEFT,  KC_MS_UP,       KC_MS_WH_RIGHT, TD(DANCE_55), LGUI(KC_LBRACKET),LCTL(LSFT(KC_TAB)),RCTL(KC_TAB),   LGUI(KC_RBRACKET),KC_TRANSPARENT, KC_NO
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
	     KC_NO, TD(DANCE_56),   KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT,    MT(MOD_LGUI,KC_DEL),    TD(DANCE_60),   MT(MOD_RGUI,KC_DOWN), MT(MOD_RALT,KC_UP),   TD(DANCE_63),   KC_ENTER, KC_NO
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
     KC_NO, TD(DANCE_58),   KC_MS_BTN2,     KC_MS_WH_UP,    KC_MS_WH_DOWN, KC_TRANSPARENT, KC_MS_BTN1,     KC_MS_ACCEL0,   KC_MS_ACCEL1,   KC_MS_ACCEL2,   KC_NO, KC_NO
  //---------------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
